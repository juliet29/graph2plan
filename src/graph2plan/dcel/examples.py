...
def deberg_embedded():
    ...
    G.add_half_edge(1, 2)  # e11
    G.add_half_edge(2, 1)  # e12

    G.add_half_edge(3, 4)  # e21
    G.add_half_edge(4, 3)  # e22

    G.add_half_edge(3, 1, ccw=4)  # e31
    G.add_half_edge(1, 3, ccw=2)  # e32

    G.add_half_edge(3, 2, ccw=1)  # e41
    G.add_half_edge(2, 3, ccw=1)  # e42
